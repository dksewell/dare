#' dare: Dose Accrual Risk Estimation
#'
#' Use longitudinal data to estimate risk ratios of accruing dose.  dare_boot uses
...
#'
#' @returns An object of class "dare", which is really a list with the following
#'  named elements:
#' \itemize{
