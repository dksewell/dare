...
#'
#' @param objects list of objects of class dare
...
#'
#' @returns updated list of objects of class dare
#'
#'
#' @export
...
SUBSET_multipath = function(objects,
  ...
  if(any(diff(P) != 0)) stop("DARE objects need to use the same covariates")
  P = P[1]
